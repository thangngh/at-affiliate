...
HUB_FAQ_JSON = '''<script type="application/ld+json">
  {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
    {"@type":"Question","name":"Accesstrade là gì?","acceptedAnswer":{"@type":"Answer","text":"Mạng affiliate Việt Nam, bạn nhận hoa hồng khi giới thiệu khách mua qua link của mình."}},
    {"@type":"Question","name":"Làm sao kiếm tiền với Accesstrade?","acceptedAnswer":{"@type":"Answer","text":"Đăng ký, lấy link affiliate, chia sẻ; khi có đơn thành công bạn nhận hoa hồng."}},
    {"@type":"Question","name":"Có mất phí tham gia không?","acceptedAnswer":{"@type":"Answer","text":"Hoàn toàn miễn phí tham gia."}},
    {"@type":"Question","name":"Link affiliate là gì?","acceptedAnswer":{"@type":"Answer","text":"Link rút gọn chứa mã giới thiệu của bạn, dùng để theo dõi đơn hàng."}},
    {"@type":"Question","name":"Có cần duyệt campaign không?","acceptedAnswer":{"@type":"Answer","text":"Một số campaign tự duyệt, một số cần đăng ký thủ công trên dashboard."}}
  ]}
  </script>'''
...
{article_links}
  ...
  <div class="card">
    <h2>Affiliate Accesstrade FAQ</h2>
    <details><summary>Accesstrade là gì?</summary><p>Mạng affiliate Việt Nam, bạn nhận hoa hồng khi giới thiệu khách mua qua link của mình.</p></details>
    <details><summary>Làm sao kiếm tiền với Accesstrade?</summary><p>Đăng ký, lấy link affiliate, chia sẻ; khi có đơn thành công bạn nhận hoa hồng.</p></details>
    <details><summary>Có mất phí tham gia không?</summary><p>Hoàn toàn miễn phí tham gia.</p></details>
    <details><summary>Link affiliate là gì?</summary><p>Link rút gọn chứa mã giới thiệu của bạn, dùng để theo dõi đơn hàng.</p></details>
    <details><summary>Có cần duyệt campaign không?</summary><p>Một số campaign tự duyệt, một số cần đăng ký thủ công trên dashboard.</p></details>
  </div>
  {HUB_FAQ_JSON}
  <footer>Affiliate tự động qua Accesstrade · Vui lòng review kỹ trước khi đăng<br>
  Copyleft © thangnh · Tự do sử dụng &amp; chia sẻ, giữ ghi công · Liên hệ: thangnh.00@gmail.com<br>
  <span style="opacity:.75">Nội dung do AI tạo · Content generated by AI</span></footer>
</body>
</html>
"""
